...
Honshu Inu is a next generation decentralized Metaverse MEME Game token build on Blockchain,
combining so many utilities from rewarding token holders to NFT Marketplace and a Play 2 Earn Game.

100% Legit Team | NFT Metaverse Project | Extraordinary Potential
* Website:   https://honshuinu.io
...
contract HonshuInu is Context, IERC20, Ownable {
    ...
    string private _name = "Honshu Inu";
    string private _symbol = "HONSHU";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 4; // HONSHU Rewards
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _sellTaxFee = 4; // HONSHU Rewards
    ...
    address public uniswapV2Pair; // HONSHU / DOGE
    address public uniswapV2BNBPair; // HONSHU / BNB
